...
export default function Contact() {
  ...
  const handleCaptchaSuccess = async () => {
    ...
    try {
      ...
      // Save to localStorage (temporary solution until backend ready)
      const existingMessages = JSON.parse(localStorage.getItem('contactMessages') || '[]');
      existingMessages.unshift(newMessage); // Add to beginning
      ...
      */
      ...
      // Success
      alert('✅ Pesan Anda telah berhasil terkirim! Kami akan segera menghubungi Anda.');
